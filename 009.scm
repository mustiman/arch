...
(and (if (if (if (if #f #f #f)
     ...
     (if (if (if #f (if #t #f #t) #t)
      ...
      (if (if (if (if #f #f #t)
              ...
              (if #t #t #f))
      (if (if (if (if (if #t #t #f) (if #f #t #f) #f)
                      (if #t #f #f)
     ...
     (if (if (if #t (if #f #t #t) #f) (if #f #f #t) #f)
         (if (if (if #f #t #t)
             ...
             (if (if #f #f #f) (if #f #f #t) #t))
         (if (if #f #t #t) (if #f #f #f) #t))
     (if (if (if (if #f #f #f) (if #t #t #f) (if #t #f #f))
     ...
     (if (if (if (if #f (if #t #f #f) (if #t #f #f))
         ...
         (if (if #f #t (if #f #f #t))
             ...
             (if #t #f #t)))
     (if (if (if #f #t #f) (if #t #t #f) (if #t #f #t))
              (if #t #t #f)
              #f)
     ...
     (if (if (if #t
         ...
         (if (if (if #t #f #f)
             ...
             (if (if #t #t #f)
                 ...
                 #f)))
     (if (if (if (if (if #t (if #f #t #f) (if #t #f #t))
                          (if #t
     ...
     (if (if (if (if #t
         ...
         (if (if (if #t #t #t)
             ...
             (if #t
				...
				(if (if (if (if (if (if #t #t #f) #t (if #t #f #t))
                          #f
                          #f)
                      (if (if #t #f #f)
                          (if (if #f #f #t)
     ...
     (if (if (if (if #t #f #f) (if #f #t #t) #f)
      ...
      (if (if (if (if (if (if #t (if #f #t #t) (if #t #f #f))
                              #f
                              (if #t #t #t))
                          (if (if (if #t #f #f)
                                  (if #t #f #t)
     ...
     (if (if (if (if (if (if (if (if #t #t #f) #f #t)
                                  (if #f #t #t)
                                  (if #t #f (if #f #t #f)))
                              (if #f #t #t)
                              (if #f #t #f))
         ...
         (if (if (if #t (if #t #f #f) #t)
             ...
             (if (if #t
                 ...
                 (if (if (if #t #t #t) #f (if #f #t #f))
                     ...
                     #f))
             #t))
      (if (if (if #t #f #t) (if #f #t #t) (if #f #t #t))
     ...
     (if (if #t
         ...
         #t
         (if (if #f #t #t) #f #t))
     (if (if (if (if #f #t #t) #f #t) (if #t #f #t) #f)
